...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.updateUserRefreshTokenByIdStmt, err = db.PrepareContext(ctx, updateUserRefreshTokenById); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateUserRefreshTokenById: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	...
	if q.updateUserRefreshTokenByIdStmt != nil {
		if cerr := q.updateUserRefreshTokenByIdStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateUserRefreshTokenByIdStmt: %w", cerr)
		}
	}
	return err
}
...
type Queries struct {
	...
	updateUserRefreshTokenByIdStmt *sql.Stmt
}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		updateUserRefreshTokenByIdStmt: q.updateUserRefreshTokenByIdStmt,
	}
}
